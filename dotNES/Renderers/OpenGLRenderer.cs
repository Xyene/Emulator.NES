    ...
    class OpenGLRenderer : GlControl, IRenderer
    {
        ...
        private void RenderControl_Render(object sender, GlControlEventArgs e)
        {
            ...
            if (_ui.gameStarted)
            {
                ...
                {
                    Gl.TexImage2D(TextureTarget.Texture2d, 0, InternalFormat.Rgba, UI.GameWidth, UI.GameHeight, 0, PixelFormat.Bgra, PixelType.UnsignedByte, locked.Address);

                }


                Gl.TextureParameterEXT(_textureId, TextureTarget.Texture2d, TextureParameterName.TextureMagFilter, _ui._filterMode == UI.FilterMode.Linear ? Gl.LINEAR : Gl.NEAREST);
